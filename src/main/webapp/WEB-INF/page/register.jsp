...
<!-- Preloader -->
<link rel="stylesheet" href="source/css/preloader.css" type="text/css"
	media="screen, print" />
				...
				<div class="row clearfix">
					<div class="col-md-6 column">
						...
						<div class="form-group">
							...
							<h6 class="text-warning" style="display: inline"
								id="dis_passwd_con">password error</h6>
